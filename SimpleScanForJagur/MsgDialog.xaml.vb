...
Public Class MsgDialog
    ...
    Private Shared ReadOnly infoImage As String = Path.Combine(My.Application.Info.DirectoryPath, "Info.png")
    Private Shared ReadOnly warningImage As String = Path.Combine(My.Application.Info.DirectoryPath, "Warning.png")
    Private Shared ReadOnly successImage As String = Path.Combine(My.Application.Info.DirectoryPath, "ok.png")
    Private Shared ReadOnly errorImage As String = Path.Combine(My.Application.Info.DirectoryPath, "Error.png")
    ...
    Public Shared Sub PlaySound(ByVal level As Object)
        ...
        Try
            ...
            Select Case CType(level, Integer)
                Case MsgLevel.Mistake
                    player.SoundLocation = System.IO.Path.Combine(My.Application.Info.DirectoryPath, "alarm.wav")
                Case MsgLevel.Info
                    player.SoundLocation = System.IO.Path.Combine(My.Application.Info.DirectoryPath, "info.wav")
                Case MsgLevel.Successful
                    player.SoundLocation = System.IO.Path.Combine(My.Application.Info.DirectoryPath, "info.wav")
                Case MsgLevel.Warning
                    player.SoundLocation = System.IO.Path.Combine(My.Application.Info.DirectoryPath, "alarm.wav")
